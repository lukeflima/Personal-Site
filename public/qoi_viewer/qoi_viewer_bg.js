...
* @returns {boolean}
*/
export function check_if_valid_qoif(bytes) {
    var ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    var ret = wasm.check_if_valid_qoif(ptr0, len0);
    return ret !== 0;
}
...
* @returns {QoiImage}
*/
export function decode_qoi(bytes, size) {
    var ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    var ret = wasm.decode_qoi(ptr0, len0, size);
